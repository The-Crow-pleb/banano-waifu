...
const configSchema = require('../../configs/dbs/schemas/guildConfig')
...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        const {guild} = message
        const prefixGet = await configSchema.findOne({_id: guild.id})
        const PREFIX = prefixGet.prefix
        ...
        const mainPage = new MessageEmbed()
            ...
            .addFields(
                ...
                {name: lang(guild, "h_d"),  value: '```Nano:\nnano_1tocka13zi1ab9zyu6a9e9e6ipg16anaxhqfsz9a3swfsux8id94zo3j3kej\nBanano:\nban_1tocka13zi1ab9zyu6a9e9e6ipg16anaxhqfsz9a3swfsux8id94zo3j3kej```'},
        ...
        const commandPage = new MessageEmbed()
            ...
            .addFields(
                {name: 'Server Settings:',    value: `\`\`\`${PREFIX}config <option> <argument>\`\`\``},
        ...
        const nodePage = new MessageEmbed()
            ...
            .addFields(
                ...
                {name: 'Block Hash Info:',    value: `\`\`\`${PREFIX}blockinfo <Block Hash>\`\`\``},
                {name: 'Banano Acc. Info:',   value: `\`\`\`${PREFIX}accinfo <Account>\`\`\``},
